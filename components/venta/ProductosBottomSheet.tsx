...
export function ProductosBottomSheet({
  ...
  // Se dispara cuando el usuario llega al 50% del final de la lista.
  // Evita llamadas duplicadas con el flag isFetchingMore.
  ...
  return (
    ...
    >
      <BottomSheetFlatList
        ...
        // ── Footer con spinner mientras carga más ────────────────────────────
