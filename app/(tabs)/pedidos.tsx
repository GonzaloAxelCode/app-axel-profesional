...
import PedidosHistorial from '@/components/PedidosComponents/PedidosHistorial';
import PedidosCrear from '@/components/PedidosComponents/PedidosCrear';

const TABS = [
    { key: 'historial', label: 'Historial de Pedidos' },
    { key: 'crear', label: 'Crear Pedido' },
];
        ...
        <View style={st.root}>
            ...
            <View style={st.headerWrap}>
                <View style={st.header}>
                    <Text style={st.title}>Pedidos</Text>
                    <Text style={st.subtitle}>Historial y registro de pedidos</Text>
                </View>
